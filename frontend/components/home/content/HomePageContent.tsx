...
const AD_DATA = [
  {
    ...
    description:
      "احصل على أفضل الخدمات الطبية في منزلك مع نخبة من الأطباء المتخصصين",
  ...
  },
  {
    ...
    description:
      "نوفر لك خدمة سحب العينات والتحاليل من منزلك بدقة وعناية فائقة",
  ...
  },
  {
    ...
    description:
      "فريق طبي متكامل لرعاية جميع أفراد أسرتك على مدار الساعة وبأعلى جودة",
