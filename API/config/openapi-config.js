...
const { SERVICES, RESERVATION_STATUS, ROLES } = require('../modules/shared/constants');
...
const definition = {
  ...
  tags: [
    ...
    { name: 'Auth', description: 'OAuth 2.0 authentication via Google and Facebook' },
    { name: 'Users', description: 'User retrieval and admin account management' },
    { name: 'Reservations', description: 'Medical reservation lifecycle management' },
  ],
  components: {
    securitySchemes: {
      bearerAuth: {
    ...
    schemas: {
      ...
      User: {
        ...
        properties: {
          ...
          email: { type: 'string', format: 'email', example: 'ahmed@example.com', nullable: true },
      ...
      ReservationDetails: {
        ...
        properties: {
          ...
          reason: { type: 'string', nullable: true, example: 'Patient requested rescheduling' },
      ...
      Reservation: {
        ...
        properties: {
          ...
          egyptianMobileNumber: { type: 'string', pattern: '^(010|011|012|015)[0-9]{8}$', example: '01023456789' },
          locationUrl: { type: 'string', format: 'uri', nullable: true, example: 'https://maps.google.com/?q=30.0444,31.2357' },
          reservationDate: { type: 'string', format: 'date-time', example: '2026-06-15T10:00:00.000Z' },
      ...
      CreateUserBody: {
        ...
        properties: {
          ...
          password: { type: 'string', format: 'password', minLength: 1, example: 'SecureP@ss1' },
          role: { $ref: '#/components/schemas/Role' },
        },
      },
      CreateReservationBody: {
        type: 'object',
        required: ['patientName', 'age', 'egyptianMobileNumber', 'service', 'userId', 'reservationDate'],
        properties: {
          ...
          reservationDate: { type: 'string', format: 'date-time', example: '2026-06-20T09:30:00.000Z' },
          assignedToId: {
            type: 'string',
            format: 'uuid',
            nullable: true,
          ...
          status: { $ref: '#/components/schemas/ReservationStatus' },
          reason: { type: 'string', nullable: true, example: 'Follow-up visit' },
        },
      },
      ...
      AuthSuccessResponse: {
        ...
        properties: {
          ...
          token: {
            type: 'string',
            description: 'JWT token valid for 7 days. Use as Bearer token in the Authorization header.',
